...
const Footer = () => {
  return (
    <footer className="bg-white w-full mt-20">
      <div className="border-t border-black border-opacity-25 px-5 pt-10 pb-5 flex flex-col gap-6 desktop:max-w-[1280px] desktop:mx-auto desktop:px-[40px] desktop:pt-[40px] desktop:pb-0 desktop:gap-5">
